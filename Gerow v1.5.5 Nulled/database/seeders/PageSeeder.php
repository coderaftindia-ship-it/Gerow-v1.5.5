...
class PageSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $pages = [
            ...
            [
                'name' => 'Testimonials',
                'content' => Html::tag('div', '[testimonials testimonial_ids="1,2,3,4" image="general/testimonial-img.png" background_image="backgrounds/testimonial-bg1.png" style="style-2"][/testimonials]'),
                'metadata' => $styleDefaultPage,
            ],
            [
                'name' => 'Projects',
