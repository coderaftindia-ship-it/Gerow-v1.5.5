                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-12">
                                                <div class="blog-post-share justify-content-start mt-4">
                                                    ...
                                                    <ul class="list-wrap">
                                                        <li><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode($post->url) }}"><i class="fab fa-facebook-f"></i></a></li>
                                                        <li><a target="_blank" href="https://twitter.com/intent/tweet?url={{ urlencode($post->url) }}&text={{ strip_tags($post->description) }}"><i class="fab fa-twitter"></i></a></li>
                                                        <li><a target="_blank" href="https://www.linkedin.com/shareArticle?mini=true&url={{ urlencode($post->url) }}&summary={{ rawurldecode(strip_tags($post->description)) }}"><i class="fab fa-linkedin-in"></i></a></li>
                                                        <li><a target="_blank" href="https://pinterest.com/pin/create/button?media={{ urlencode(RvMedia::getImageUrl($post->image, null, false, RvMedia::getDefaultImage())) }}&url={{ urlencode($post->url) }}&description={{ strip_tags($post->description) }}"><i class="fab fa-pinterest-p"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
